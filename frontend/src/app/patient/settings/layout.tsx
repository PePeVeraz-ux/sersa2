...
const navItems = [
  { title: 'Perfil', href: '/patient/settings', icon: User, exact: true },
  { title: 'Seguridad', href: '/patient/settings/security', icon: Shield },
  { title: 'Notificaciones', href: '/patient/settings/notifications', icon: Bell },
];
